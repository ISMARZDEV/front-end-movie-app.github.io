// filepath: /Users/ISMARTZ/Desktop/DEV/project.front-end/src/app/_metronic/layout/core/layout.service.ts
...
const defaultBaseLayoutType: LayoutType = 'dark-header'; // Cambia esto a 'dark-header'
const defaultLayoutConfig: ILayout = DarkHeaderConfig; // Cambia esto a DarkHeaderConfig
